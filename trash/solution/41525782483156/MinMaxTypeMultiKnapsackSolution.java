...
public class MinMaxTypeMultiKnapsackSolution {
	...
	public static void main(String[] args) {
		...
		solution.loadData(
				"src/khmtk60/miniprojects/multiknapsackminmaxtypeconstraints/41525782483156.json");
		solution.initModel();
		solution.tabuSearch(1, 500, 100000, 5000); // Cho tap du lieu 41525782483156.json
	}
